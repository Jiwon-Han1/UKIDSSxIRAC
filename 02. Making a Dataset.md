...
<img width="679" alt="image" src="https://github.com/Jiwon-Han1/UKIDSSxWISE/assets/147721921/520bd101-e976-4d51-9a07-8f7963b270ac">

<img width="654" alt="image" src="https://github.com/Jiwon-Han1/UKIDSSxWISE/assets/147721921/1f30904e-fe17-449f-a8ab-7626c0945d8b">
...
```
**&rarr; Five Sources are Returned**
<img width="1219" alt="image" src="https://github.com/Jiwon-Han1/UKIDSSxWISE/assets/147721921/8bba7b98-acfd-4ce1-9f69-d84e6701f78f">

```SQL
SELECT U.sourceID, U.frameSetID, U.ra, U.dec,
       U.yAperMag3, U.yAperMag3Err, U.jAperMag3, U.jAperMag3Err, U.hAperMag3, U.hAperMag3Err, U.kAperMag3, U.kAperMag3Err
  FROM lasPointSource AS U
 WHERE U.ra BETWEEN 179-0.0416667 AND 179+00.0416667 AND
       U.dec BETWEEN 0.5-0.0416667 AND 0.5+0.0416667
       -- Within a radius of ±2.5' from the central point at RA =179, Dec=0.5
```
